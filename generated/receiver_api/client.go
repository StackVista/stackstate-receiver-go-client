...
// APIClient manages communication with the SUSE Observability Receiver API API v5.2.0
...
func (c *APIClient) decode(v interface{}, b []byte, contentType string) (err error) {
	...
	return fmt.Errorf("unknown content type, should be json or xml: %s", contentType)
}
